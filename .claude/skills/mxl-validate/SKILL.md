...
Проверяет Template.xml на структурные ошибки: индексы, ссылки на палитры, диапазоны именованных областей и объединений, согласованность типа области с заданными осями, форматы ячеек-полей ввода.
