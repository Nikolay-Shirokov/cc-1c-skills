...
регистрирует объект в `Configuration.xml` (в конец группы своего типа; при `"childObjectsOrder": "alphabetical"`
в `.v8-project.json` — по алфавиту, как требует АПК:1108).
