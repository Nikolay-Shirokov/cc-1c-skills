---
name: img-grid
description: Наложить пронумерованную сетку на изображение для определения пропорций колонок. Использовать при анализе скриншота макета или печатной формы для измерения ширины колонок перед генерацией MXL
