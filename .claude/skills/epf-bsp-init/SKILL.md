---
name: epf-bsp-init
description: Добавить функцию регистрации БСП (СведенияОВнешнейОбработке) в модуль объекта обработки. Использовать, когда пользователь просит адаптировать обработку под БСП, подключить к «Дополнительные отчёты и обработки»
