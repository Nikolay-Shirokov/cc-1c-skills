...
| Утилиты | `/img-grid`, `/syntax-help` | Наложение сетки на изображение для определения пропорций колонок; поиск и чтение синтакс-помощника установленной платформы | — |
...
└── syntax-help/         # Синтакс-помощник платформы: поиск и чтение
scripts/
